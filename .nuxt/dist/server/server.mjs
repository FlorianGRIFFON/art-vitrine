...
const _routes = [
  {
    name: "animations",
    path: "/animations",
    component: () => import("./_nuxt/animations-c3TwVD6w.js").then((m) => m.default || m)
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import("./_nuxt/contact-DGC7HUqf.js").then((m) => m.default || m)
  },
  {
    name: "digital-drawings",
    path: "/digital-drawings",
    component: () => import("./_nuxt/digital-drawings-DDwbg1cR.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CS8AVMyf.js").then((m) => m.default || m)
  },
  {
    name: "studies",
    path: "/studies",
    component: () => import("./_nuxt/studies--DxSSdft.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-ifX_iXl-.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DupiBqiB.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-D6VBh5Mm.js").then((r) => r.default || r));
